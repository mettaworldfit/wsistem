<?php $list = Help::showPrice_listID($_GET['id']);
while ($element = $list->fetch_object()): ?>
            ...
            <div class="container row">
                ...
                <div class="form-group col-md-8">
                    <div class="form-group d-flex">
                        ...
                        <input class="form-custom col-sm-12 ml-3" type="text" value="<?= $element->nombre_lista ?>" name=""
                            id="list_name" required>
