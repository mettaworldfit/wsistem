<div class="section-wrapper">
    ...
    <p class="title-info">Utiliza los impuestos para agregar una carga fiscal sobre el consumo, financiado por el
        consumidor como impuesto regresivo</p>
</div>



<div class="generalContainer-medium">
    <form action="" onsubmit="event.preventDefault(); AddTax();">
        <div class="container row">

            <div class="form-group col-md-8">
                <div class="form-group d-flex">
                    <label for="" class="col-sm-3 text-right">Nombre<span class="text-danger">*</span></label>
                    <input class="form-custom col-sm-12 ml-3" type="text" name="" id="tax_name" required>
