...
<div class="generalContainer-medium">
    <form action="" onsubmit="event.preventDefault(); UpdateCategorie('<?= $element->categoria_id ?>');">
        <div class="container row">

            <div class="form-group col-md-8">
                <div class="form-group d-flex">
                    <label for="" class="col-sm-3 text-right ">Nombre<span class="text-danger">*</span> </label>
                    <input class="form-custom col-sm-12" type="text" name="" value="<?= $element->nombre_categoria ?>" id="category_name" required>
                ...
                <div class="form-group mt-3 d-flex">
                    ...
                    <textarea class="form-control" name="" id="category_comment" cols="23" rows="5" maxlength="200"> <?= $element->descripcion ?></textarea>
                </div>
            </div>
