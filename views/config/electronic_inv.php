        ...
        while ($element = $config->fetch_object()): ?>
            ...
            <div class="container row">
                ...
                <div class="form-group col-md-8">
                    ...
                    <div class="form-group d-flex">
                        <label for="email" class="col-sm-3 text-right ">Correo<span class="text-danger">*</span></label>
                        <input class="form-custom col-sm-12 ml-3" type="text" value="<?= $element->email ?>" name="email" id="email" required>
                    ...
                    <div class="form-group d-flex">
                        <label for="contraseña" class="col-sm-3 text-right ">Contraseña<span class="text-danger">*</span></label>
                        <input class="form-custom col-sm-12 ml-3" type="text" value="<?= $element->password ?>" name="contraseña" id="password" required>
                    ...
                    <div class="form-group d-flex">
                        <label for="port" class="col-sm-3 text-right ">Puerto<span class="text-danger">*</span></label>
                        <input class="form-custom col-sm-12 ml-3" type="text" value="<?= $element->puerto ?>" name="port" id="port" required>
