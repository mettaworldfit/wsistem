...
<div class="generalContainer-medium">
    <form action="" onsubmit="event.preventDefault(); AddOffer();">
        <div class="container row">

            <div class="form-group col-md-8">
                <div class="form-group d-flex">
                    <label for="" class="col-sm-3 text-right ">Nombre<span class="text-danger">*</span></label>
                    <input class="form-custom col-sm-12 ml-3" type="text" name="" id="offer_name" required>
                ...
                <div class="form-group mt-3 d-flex">
                    ...
                    <input class="form-custom col-sm-5" type="number" name="" id="offer_value" required>
                ...
                <div class="form-group mt-3 d-flex">
                    ...
                    <textarea class="form-control" name="" id="offer_comment" cols="23" rows="5"
