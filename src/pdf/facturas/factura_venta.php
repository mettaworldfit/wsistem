...
<body>
    ...
    <div id="page_pdf">
        ...
        <div>
            ...
            <p>Le atendió.: <?= ucwords($data->nombre_usuario) ?> <?= ucwords($data->apellidos_usuario) ?></p>
            ...
            <br><br>
            <p class="nota textcenter"><?= $policyPDF ?></p>
            <br>
            <!-- <p class="nota textcenter"></p>
            <br>
            <p class="nota textcenter"></p>
            <br> -->
            <p class="nota textcenter"><b><?= $footerPDF ?></b></p>
