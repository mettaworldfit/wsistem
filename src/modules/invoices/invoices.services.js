...
import * as qz from "../../../public/qz/connection.js";
...
$(document).ready(function () { 
    ...
    * FACTURACION E IMPRESION
    ...
    function GeneratePDF(invoice) {
        ...
        var url = SITE_URL + 'src/services/pdf/generar_factura_venta.php?f=' + invoice + '&sub=' + data.subtotal + '&dis=' + data.discount + '&tax=' + data.taxes + '&total=' + data.total;
