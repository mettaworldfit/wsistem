<?php $providers = Help::showProvidersID($_GET['id']);
while ($element = $providers->fetch_object()): ?>
    ...
    <div class="area-data">
        <div class="col-data">
            ...
            <form action="" onsubmit="event.preventDefault(); UpdateProvider('<?= $element->proveedor_id ?>');">
                <div class="row col-md-12">

                    <div class="form-group col-sm-7">
                        <label for="Nombre" class="form-check-label label-nomb">Nombre/Razón social<span
                                class="text-danger">*</span></label>
                        <input class="form-custom" type="text" name="" value="<?= ucwords($element->nombre_proveedor) ?>"
                            id="name" required>
                    </div>
