...
$(document).ready(function () {
    ...
    async function deleteItemPOS(detailId) {
        ...
        const response = await fetch(API_URL + 'api/pos/eliminar_detalle', {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    async function updateToListPrice(listId, productId = 0) {
        ...
        const response = await fetch(API_URL + 'api/pos/actualizar_precio', {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    async function handleQuantityUpdate($input) {
        ...
        const response = await fetch(API_URL + 'api/pos/actualizar_cantidad', {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    * VENTANA EDITAR
    ...
    $('.pos-count-item').on('click', async function () {
        ...
        alertify.confirm("<i class='text-warning fas fa-exclamation-circle'></i> Borrar todo el detalle", "¿Desea borrar todo el detalle? ",
            async function () {
                ...
                const response = await fetch(API_URL + 'api/pos/eliminar_todo', {
                    method: 'DELETE',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    $('#updatePosItem').on('click', async function () {
        ...
        const response = await fetch(API_URL + 'api/pos/editar_detalle', {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
   ...
   * VENTANA DE CLIENTE
   ===============================================================*/
    ...
    function initClientSelect2(selector, selectedId = null) {
        ...
        $select.select2({
            ...
            allowClear: true, // Permite limpiar la selección
            ajax: {
                url: SITE_URL + 'src/modules/contacts/contacts.repository.php',
                method: 'POST',
                dataType: 'json',
                data: params => ({
    ...
    $('#orderForm').on('submit', async function (e) {
        ...
        const response = await fetch(API_URL + 'api/pos/agregar_orden', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    *  VENTANA DATOS DE LA ORDEN DE COMPRA
    ...
    $('#updateOrderForm').on('submit', async function (e) {
        ...
        const response = await fetch(API_URL + 'api/pos/actualizar_orden', {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
   ...
   */
    ...
    $('.pos-button-cash').on('click', async function () {
        ...
        const response = await fetch(API_URL + 'api/pos/factura_contado', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    $('#invoiceCredit').on('submit', async function (e) {
        ...
        const response = await fetch(API_URL + 'api/pos/factura_credito', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    function generatePDF(invoice_id) {
        sendAjaxRequest({
            ...
            successCallback: (response) => {
                ...
                var url = SITE_URL + 'src/services/pdf/generar_factura_venta.php?f=' + invoice_id + '&sub=' + dataInv.subtotal + '&dis=' + dataInv.discount + '&tax=' + dataInv.taxes + '&total=' + dataInv.total;
